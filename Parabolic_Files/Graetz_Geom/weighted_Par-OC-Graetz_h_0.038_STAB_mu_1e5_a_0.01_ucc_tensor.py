...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "weighted_Parabolic_OCGraetzPOD3_GEOM_h_0.043_STAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta0503_0503_ucc_tensor"
...
elliptic_optimal_control.export_solution(filename="FEM_UQ_beta0503_0503_Par_OCGraetz_h_0.038_STAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
...
#reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
#reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
...
#print("")
#pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_beta0503_0503_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01_ucc_tensor_article2")
