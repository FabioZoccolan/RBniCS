...
# Save
File("graetzOC_N_18798.xml") << mesh
File("graetzOC_N_18798_physical_region.xml") << subdomains
File("graetzOC_N_18798_facet_region.xml") << boundaries
XDMFFile("graetzOC_N_18798.xdmf").write(mesh)
XDMFFile("graetzOC_N_18798_physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_N_18798_facet_region.xdmf").write(boundaries)
