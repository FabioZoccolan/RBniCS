...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Parabolic_OCGraetzPOD3_GEOM_h_0.038_STAB_mu_1e5_3.0_alpha_0.01_d_1_article2"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            for i in range(Nt):
                ...
                ms_3[i, i] = - h * inner(p[i].dx(0), z[i])*dx(2) - h * inner(p[i].dx(0), z[i])*dx(3) - h * inner(p[i].dx(0), z[i])*dx(4)
            for i in range(Nt-1):
                ...
                ms_3[i+1, i] = + h*inner(p[i+1].dx(0), z[i])*dx(2) + h*inner(p[i+1].dx(0), z[i])*dx(3) + h*inner(p[i+1].dx(0), z[i])*dx(4)
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCGraetz2_GEOM_h_0.038_STAB_mu_1e5_alpha_0.01")
...
#reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.0_alpha_0.01")
#reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.0_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.0_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.0_alpha_0.01")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.0_alpha_0.01")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.0_alpha_0.01")
...
#print("")
#pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.0_alpha_0.01")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.0_alpha_0.01")
