...
# Save
File("squareOC_N_3594.xml") << mesh
File("squareOC_N_3594_physical_region.xml") << subdomains
File("squareOC_N_3594_facet_region.xml") << boundaries
XDMFFile("squareOC_N_3594.xdmf").write(mesh)
XDMFFile("squareOC_N_3594_physical_region.xdmf").write(subdomains)
XDMFFile("squareOC_N_3594_facet_region.xdmf").write(boundaries)
