...
# Save
File("graetzOC_N_9360.xml") << mesh
File("graetzOC_N_9360_physical_region.xml") << subdomains
File("graetzOC_N_9360_facet_region.xml") << boundaries
XDMFFile("graetzOC_N_9360.xdmf").write(mesh)
XDMFFile("graetzOC_N_9360_physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_N_9360_facet_region.xdmf").write(boundaries)
