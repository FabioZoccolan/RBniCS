...
mesh = generate_mesh(domain, 50) #50 --> 3211, h=0.040 #120 --> 0.016
plot(mesh)
...
# Save
File("graetz_h_0.040.xml") << mesh
File("graetz_h_0.040_physical_region.xml") << subdomains
File("graetz_h_0.040_facet_region.xml") << boundaries
XDMFFile("graetz_h_0.040.xdmf").write(mesh)
XDMFFile("graetz_h_0.040_physical_region.xdmf").write(subdomains)
XDMFFile("graetz_h_0.040_facet_region.xdmf").write(boundaries)
