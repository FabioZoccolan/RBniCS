...
# Save
File("graetzOC.xml") << mesh
File("graetzOC_physical_region.xml") << subdomains
File("graetzOC_facet_region.xml") << boundaries
XDMFFile("graetzOC.xdmf").write(mesh)
XDMFFile("graetzOC_physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_facet_region.xdmf").write(boundaries)
