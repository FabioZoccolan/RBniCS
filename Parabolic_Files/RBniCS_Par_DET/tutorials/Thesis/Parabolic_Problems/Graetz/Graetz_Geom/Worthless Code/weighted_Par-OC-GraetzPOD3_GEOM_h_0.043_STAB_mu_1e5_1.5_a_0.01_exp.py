...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def __init__(self, block_V, **kwargs):
       ...
       # Customize linear solver parameters
        ...
        PETScOptions.set("mat_mumps_icntl_7", 4)
        PETScOptions.set("mat_mumps_icntl_14", 99)

    # Return custom problem name
    def name(self):
        return "aweighted_Parabolic_OCGraetzPOD3_GEOM_h_0.043_STAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575"
...
elliptic_optimal_control.export_solution(filename="FEM_weigthed_Par_OCGraetz2_GEOM_h_0.043_STAB_mu_1e5_2.0_a_0.01_T_3_t_0.1_beta7575_7575")
...
#reduced_elliptic_optimal_control.export_solution(filename="online_solution_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")
#reduced_elliptic_optimal_control.export_error(filename="online_error_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")
reduced_elliptic_optimal_control.export_error(filename="online_error_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")
...
#pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")
...
#print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")

print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_weigthed_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_0.5_a_0.01_T_3_t_0.1_beta7575_7575")
