...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def __init__(self, block_V, **kwargs):
       ...
       # Customize linear solver parameters
        ...
        PETScOptions.set("mat_mumps_icntl_7", 7)
        PETScOptions.set("mat_mumps_icntl_14", 90)

    # Return custom problem name
    def name(self):
        return "Parabolic_OCGraetzPOD3_GEOM_h_0.043_STAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest_sametest"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCGraetz2_GEOM_h_0.043_STAB_mu_1e5_a_0.01_T_3_t_0.1_sametest")
...
pod_galerkin_method.initialize_training_set(100, enable_import = True)
...
#reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")
#reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")
...
#pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")
...
#print("")
#pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OCGraetz2_GEOM_h_0.043_OffSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")

print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OCGraetz2_GEOM_h_0.043_OffONSTAB_mu_1e5_3.3_a_0.01_T_3_t_0.1_sametest")
