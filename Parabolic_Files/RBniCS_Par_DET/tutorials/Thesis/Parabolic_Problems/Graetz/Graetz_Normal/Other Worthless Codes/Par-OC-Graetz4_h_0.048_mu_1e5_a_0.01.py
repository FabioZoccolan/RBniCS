...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Parabolic_OCGraetzPOD2_h_0.048_mu_1e5_alpha_0.01_d_1"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCGraetz2_h_0.048_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz2_h_0.048_mu_1e5_alpha_0.01")
