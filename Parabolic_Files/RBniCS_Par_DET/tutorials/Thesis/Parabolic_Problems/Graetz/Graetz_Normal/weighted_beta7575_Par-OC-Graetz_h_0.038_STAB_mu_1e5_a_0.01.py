...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Beta_7575_weighted_Parabolic_OCGraetzPOD_h_0.038_STAB_mu_1e5_alpha_0.01_d_1"
...
elliptic_optimal_control.export_solution(filename="FEM_UQ_Beta7575_Par_OCGraetz_h_0.038_STAB_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Beta7575_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Beta7575_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Beta7575_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Beta7575_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_Beta7575_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_Beta7575_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_Beta7575_Par_OCGraetz_h_0.038_OffSTAB_mu_1e5_alpha_0.01")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_Beta7575_Par_OCGraetz_h_0.038_OffONSTAB_mu_1e5_alpha_0.01")
