...
# Save
File("graetzOC_h.xml") << mesh
File("graetzOC_h_physical_region.xml") << subdomains
File("graetzOC_h_facet_region.xml") << boundaries
XDMFFile("graetzOC_h.xdmf").write(mesh)
XDMFFile("graetzOC_h_physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_h_facet_region.xdmf").write(boundaries)
