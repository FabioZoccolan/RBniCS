...
# Save
File("graetzOC_h_0.038.xml") << mesh
File("graetzOC_h_0.038_physical_region.xml") << subdomains
File("graetzOC_h_0.038_facet_region.xml") << boundaries
XDMFFile("graetzOC_h_0.038.xdmf").write(mesh)
XDMFFile("graetzOC_h_0.038_physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_h_0.038_facet_region.xdmf").write(boundaries)
