...
# Save
File("graetzOC_h_0.036.xml") << mesh
File("graetzOC_h_0.036_physical_region.xml") << subdomains
File("graetzOC_h_0.036_facet_region.xml") << boundaries
XDMFFile("graetzOC_h_0.036.xdmf").write(mesh)
XDMFFile("graetzOC_h_0.036_physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_h_0.036_facet_region.xdmf").write(boundaries)
