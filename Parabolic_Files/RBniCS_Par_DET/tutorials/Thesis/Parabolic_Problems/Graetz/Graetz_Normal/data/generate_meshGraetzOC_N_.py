...
# Save
File("graetzOC_Z_.xml") << mesh
File("graetzOC_Z__physical_region.xml") << subdomains
File("graetzOC_Z_facet_region.xml") << boundaries
XDMFFile("graetzOC_Z_.xdmf").write(mesh)
XDMFFile("graetzOC_Z__physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_Z__facet_region.xdmf").write(boundaries)
