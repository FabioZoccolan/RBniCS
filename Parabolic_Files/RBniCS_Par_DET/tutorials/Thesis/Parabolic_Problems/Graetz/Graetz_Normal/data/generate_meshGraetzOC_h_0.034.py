...
# Save
File("graetzOC_h_0.034.xml") << mesh
File("graetzOC_h_0.034_physical_region.xml") << subdomains
File("graetzOC_h_0.034_facet_region.xml") << boundaries
XDMFFile("graetzOC_h_0.034.xdmf").write(mesh)
XDMFFile("graetzOC_h_0.034_physical_region.xdmf").write(subdomains)
XDMFFile("graetzOC_h_0.034_facet_region.xdmf").write(boundaries)
