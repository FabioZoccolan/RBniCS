...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "weighted_Parabolic_OC-Boundary-Graetz6_h_0.037_STAB_D_1_mu_100000a_1_T_3_beta7575"
...
# Mesh
mesh = Mesh("data/graetz_BC6_h_0.037.xml")
subdomains = MeshFunction("size_t", mesh, "data/graetz_BC6_h_0.037_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetz_BC6_h_0.037_facet_region.xml")
...
beta_a = [75 for _ in range(1)]
beta_b = [75 for _ in range(1)]
...
elliptic_optimal_control.export_solution(filename="FEM_weighted_Par_OC-Boundary-Graetz6_h_0.037_STAB_D_1_mu_1e5_a_1_beta7575")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_beta7575")
reduced_elliptic_optimal_control.export_error(filename="online_error_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_beta7575")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_beta7575")
reduced_elliptic_optimal_control.export_error(filename="online_error_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_beta7575")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_beta7575")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_beta7575")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_beta7575")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_weighted_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_beta7575")
