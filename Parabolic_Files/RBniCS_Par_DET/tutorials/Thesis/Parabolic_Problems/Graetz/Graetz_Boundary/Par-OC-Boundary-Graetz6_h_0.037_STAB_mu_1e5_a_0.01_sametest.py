...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Parabolic_OC-Boundary-Graetz6_h_0.037_STAB_D_1_mu_1e5_a_1_sametest"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OC-Boundary-Graetz6_h_0.037_STAB_D_1_mu_1e5_a_1_sametest")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_sametest")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_sametest")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_sametest")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_sametest")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_sametest")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_sametest")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OC-Boundary-Graetz6_h_0.037_OffSTAB_D_1_mu_1e5_a_1_sametest")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OC-Boundary-Graetz6_h_0.037_OffONSTAB_D_1_mu_1e5_a_1_sametest")
