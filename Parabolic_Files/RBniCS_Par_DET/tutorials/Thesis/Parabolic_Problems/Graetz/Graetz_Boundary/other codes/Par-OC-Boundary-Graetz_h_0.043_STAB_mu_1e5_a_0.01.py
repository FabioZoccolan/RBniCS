...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def __init__(self, block_V, **kwargs):
        ...
        PETScOptions.set("mat_mumps_icntl_7", 1)
        PETScOptions.set("mat_mumps_icntl_14", 90)

    # Return custom problem name
    def name(self):
        return "Numerical_result/Parabolic_OC-Boundary-Graetz_h_0.043_STAB_mu_100000_alpha_0.01_d_1"
...
# Mesh
mesh = Mesh("data/graetz_BC6_h_0.043.xml")
subdomains = MeshFunction("size_t", mesh, "data/graetz_BC6_h_0.043_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetz_BC6_h_0.043_facet_region.xml")
print("hMax: ", mesh.hmax() )
# Dirichlet boundary
control_boundary = MeshRestriction(mesh, "data/graetz_BC6_h_0.043_restriction_control.rtc.xml")
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OC-Boundary-Graetz_h_0.043_STAB_mu_100000_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz_h_0.043_OffSTAB_mu_100000_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz_h_0.043_OffSTAB_mu_100000_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz_h_0.043_OffONSTAB_mu_100000_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz_h_0.043_OffONSTAB_mu_100000_alpha_0.01")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OC-Boundary-Graetz_h_0.043_OffSTAB_mu_100000_alpha_0.01")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OC-Boundary-Graetz_h_0.043_OffONSTAB_mu_100000_alpha_0.01")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OC-Boundary-Graetz_h_0.043_OffSTAB_mu_100000_alpha_0.01")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OC-Boundary-Graetz_h_0.043_OffONSTAB_mu_100000_alpha_0.01")
