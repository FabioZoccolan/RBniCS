...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Parabolic_OC-Boundary-Graetz8_h_0.037_STAB+Bound_D_1_D_1.0_mu_10000_alpha_1_d_1_T_6.0"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            for i in range(Nt):
                ...
                m1_0[i,i] = - dt * h * inner(y[i], z[i].dx(0)) * dx(1) - dt * h * inner(y[i], z[i].dx(0)) * dx(3)
            ...
            for i in range(Nt):
                ...
                g1_0[i] = - dt *h * y_d * z[i].dx(0) * dx(1) - dt*h * y_d * z[i].dx(0) * dx(3)
            g0 = [g0_0, 0, 0]
            g1 = [g1_0, 0, 0]
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OC-Boundary-Graetz8_h_0.037_STAB+Bound_D_1_D_1_mu_10000_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+Bound_D_1_D_1_mu_10000_alpha_1")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+Bound_D_1_D_1_mu_10000_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+Bound_D_1_D_1_mu_10000_alpha_1")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+Bound_D_1_D_1_mu_10000_alpha_1")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+Bound_D_1_D_1_mu_10000_alpha_1")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+Bound_D_1_D_1_mu_10000_alpha_1")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+Bound_D_1_D_1_mu_10000_alpha_1")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+Bound_D_1_D_1_mu_10000_alpha_1")
