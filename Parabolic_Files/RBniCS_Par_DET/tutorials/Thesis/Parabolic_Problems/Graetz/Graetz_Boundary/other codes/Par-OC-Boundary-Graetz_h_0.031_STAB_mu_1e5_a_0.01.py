...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Parabolic_OC-Boundary-Graetz_h_0.031_STAB_mu_1e5_alpha_0.01_d_1"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            y_d = self.y_d
            h0 = y_d * y_d * dx(1, domain=mesh) + y_d * y_d * dx(3, domain=mesh) 
            return (h0,)
        elif term == "dirichlet_bc_y":
            bc0 = BlockDirichletBC([[[DirichletBC(self.V.sub(i), Constant(0.5), self.boundaries, 1)] for i in range(0, Nt)], None, None])
            return (bc0,)
...
# Mesh
mesh = Mesh("data/graetz_BC6_h_0.031.xml")
subdomains = MeshFunction("size_t", mesh, "data/graetz_BC6_h_0.031_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetz_BC6_h_0.031_facet_region.xml")
print("hMax: ", mesh.hmax() )
# Dirichlet boundary
control_boundary = MeshRestriction(mesh, "data/graetz_BC6_h_0.031_restriction_control.rtc.xml")
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OC-Boundary-Graetz_h_0.031_STAB_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz_h_0.031_OffSTAB_mu_1e5_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz_h_0.031_OffSTAB_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz_h_0.031_OffONSTAB_mu_1e5_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz_h_0.031_OffONSTAB_mu_1e5_alpha_0.01")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OC-Boundary-Graetz_h_0.031_OffSTAB_mu_1e5_alpha_0.01")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OC-Boundary-Graetz_h_0.031_OffONSTAB_mu_1e5_alpha_0.01")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OC-Boundary-Graetz_h_0.031_OffSTAB_mu_1e5_alpha_0.01")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OC-Boundary-Graetz_h_0.031_OffONSTAB_mu_1e5_alpha_0.01")
