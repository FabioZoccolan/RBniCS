...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Parabolic_OC-Boundary-Graetz8_h_0.037_STAB+D_1_D_1.5_mu_100000_alpha_1_d_1_T_6.0"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OC-Boundary-Graetz8_h_0.037_STAB+D_1_D_1.5_mu_100000_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+D_1_D_1.5_mu_100000_alpha_1")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+D_1_D_1.5_mu_100000_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+D_1_D_1.5_mu_100000_alpha_1")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+D_1_D_1.5_mu_100000_alpha_1")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+D_1_D_1.5_mu_100000_alpha_1")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+D_1_D_1.5_mu_100000_alpha_1")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffSTAB+D_1_D_1.5_mu_100000_alpha_1")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OC-Boundary-Graetz8_h_0.037_OffONSTAB+D_1_D_1.5_mu_100000_alpha_1")
