...
subdomain2 = Rectangle(Point(1., 0.1), Point(2, 0.9))
subdomain3 = Rectangle(Point(1., 0.), Point(2., 0.1))
subdomain4 = Rectangle(Point(1., 0.9), Point(2., 1.))
...
# Save
File("graetz_BC4.xml") << mesh
File("graetz_BC4_physical_region.xml") << subdomains
File("graetz_BC4_facet_region.xml") << boundaries
File("graetz_BC4_restriction_control.rtc.xml") << control_restriction
XDMFFile("graetz_BC4.xdmf").write(mesh)
XDMFFile("graetz_BC4_physical_region.xdmf").write(subdomains)
XDMFFile("graetz_BC4_facet_region.xdmf").write(boundaries)
XDMFFile("graetz_BC4_restriction_control.rtc.xdmf").write(control_restriction)
