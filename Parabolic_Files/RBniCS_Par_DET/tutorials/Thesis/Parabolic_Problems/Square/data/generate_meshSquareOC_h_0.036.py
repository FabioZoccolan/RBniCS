...
# Save
File("squareOC_h_0.036.xml") << mesh
File("squareOC_h_0.036_physical_region.xml") << subdomains
File("squareOC_h_0.036_facet_region.xml") << boundaries
XDMFFile("squareOC_h_0.036.xdmf").write(mesh)
XDMFFile("squareOC_h_0.036_physical_region.xdmf").write(subdomains)
XDMFFile("squareOC_h_0.036_facet_region.xdmf").write(boundaries)
