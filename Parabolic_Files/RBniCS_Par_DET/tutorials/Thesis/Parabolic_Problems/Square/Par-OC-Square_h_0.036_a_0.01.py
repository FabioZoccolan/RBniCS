...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def __init__(self, block_V, **kwargs):
        ...
        #self.y_0 = Expression("0.0 + 1.0*(x[0] == 0.0)*(x[1] == 0.25)", degree=1, domain= mesh) 
    ...
    def name(self):
        return "Parabolic_OCSquare_h_0.036_mu_2e4_1.2_alpha_0.01_"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCSquare_h_0.036_mu_2e4_1.2_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCSquare_h_0.036_mu_2e4_1.2_alpha_0.01")
...
pod_galerkin_method.error_analysis(filename="error_analysis_Par_OCSquare_h_0.036_mu_2e4_1.2_alpha_0.01")

# 8. Perform a speedup analysis
pod_galerkin_method.speedup_analysis(filename="speedup_analysis_Par_OCSquare_h_0.036_mu_2e4_1.2_alpha_0.01")
