...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Parabolic_OCSquare_h_0.036_STAB_mu_2e4_1.2_alpha_0.01_d_1.0"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            for i in range(1,Nt):
                ...
                m_0[i, i] =  y[i] * q[i]*dx 
                m_1[i, i] =  h * y[i] * q[i].dx(0)*dx
                m_2[i, i] =  h * y[i] * q[i].dx(1)*dx
            for i in range(Nt-1):
                m_0[i+1, i] = - y[i]*q[i+1]*dx 
                m_1[i+1, i] = - h * y[i] * q[i+1].dx(0)*dx
                m_2[i+1, i] = - h * y[i] * q[i+1].dx(1)*dx
            ...
            for i in range(Nt):
                ...
                ms_0[i, i] =  p[i] * z[i] *dx 
                ms_1[i, i] =  -h * p[i]* z[i].dx(0)*dx
                ms_2[i, i] =  -h * p[i]*z[i].dx(1)*dx
            for i in range(Nt-1):
                ms_0[i, i+1] = - p[i+1] * z[i]*dx 
                ms_1[i, i+1] = + h * p[i+1] * z[i].dx(0)*dx
                ms_2[i, i+1] = + h * p[i+1] * z[i].dx(1)*dx
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCSquare_h_0.036_STAB_mu_2e4_1.2_alpha_0.01_d_1.0")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_d_1.0")
