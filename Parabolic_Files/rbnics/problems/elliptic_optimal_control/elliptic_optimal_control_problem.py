...
print("\nEllipticOptimalControlProblem_Base = LinearProblem(ParametrizedDifferentialProblem) - BEGIN")
EllipticOptimalControlProblem_Base = LinearProblem(ParametrizedDifferentialProblem)
print("EllipticOptimalControlProblem_Base = LinearProblem(ParametrizedDifferentialProblem) - END\n")
    ...
    class ProblemSolver(EllipticOptimalControlProblem_Base.ProblemSolver):
        def matrix_eval(self):
            ...
            for term in ("a", "a*", "c", "c*", "m", "n"):
                ...
                #print(assembled_operator[term]) it prints an matrix object in dolphin
            return (
