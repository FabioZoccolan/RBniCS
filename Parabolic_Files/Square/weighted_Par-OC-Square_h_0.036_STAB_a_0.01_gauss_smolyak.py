...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "UQ_Parabolic_OCSquare_h_0.036_STAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak"
...
mu_range = [(1,40000), (0.9, 1.5)]   #[(1e4,1e5), (0.0, 1.57)]  # [(1e4,5e5), (0.01, 6.3)]
...
elliptic_optimal_control.export_solution(filename="FEM_UQ_Par_OCSquare_h_0.036_STAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
#reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
#reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
print("")
#pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_Par_OCSquare_h_0.036_OffSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_Par_OCSquare_h_0.036_OffONSTAB_mu_2e4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
