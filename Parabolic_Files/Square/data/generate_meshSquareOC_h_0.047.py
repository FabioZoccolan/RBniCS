...
mesh = generate_mesh(domain, 27) #27 --> 3594 h =0.0471
plot(mesh)
...
# Save
File("squareOC_h_0.047.xml") << mesh
File("squareOC_h_0.047_physical_region.xml") << subdomains
File("squareOC_h_0.047_facet_region.xml") << boundaries
XDMFFile("squareOC_h_0.047.xdmf").write(mesh)
XDMFFile("squareOC_h_0.047_physical_region.xdmf").write(subdomains)
XDMFFile("squareOC_h_0.047_facet_region.xdmf").write(boundaries)
