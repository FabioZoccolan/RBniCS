...
mesh = generate_mesh(domain, 26) #26--> 1107 #54 -->4652 26--> h= 0.049
...
# Save
File("square_h_0.049.xml") << mesh
File("square_h_0.049_physical_region.xml") << subdomains
File("square_h_0.049_facet_region.xml") << boundaries
XDMFFile("square_h_0.049.xdmf").write(mesh)
XDMFFile("square_h_0.049_physical_region.xdmf").write(subdomains)
XDMFFile("square_h_0.049_facet_region.xdmf").write(boundaries)
