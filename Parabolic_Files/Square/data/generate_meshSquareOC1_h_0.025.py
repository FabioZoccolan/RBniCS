...
mesh = generate_mesh(domain, 50) #27 --> 3594 h =0.0471
plot(mesh)
...
# Save
File("squareOC1_h_0.025.xml") << mesh
File("squareOC1_h_0.025_physical_region.xml") << subdomains
File("squareOC1_h_0.025_facet_region.xml") << boundaries
XDMFFile("squareOC1_h_0.025.xdmf").write(mesh)
XDMFFile("squareOC1_h_0.025_physical_region.xdmf").write(subdomains)
XDMFFile("squareOC1_h_0.025_facet_region.xdmf").write(boundaries)
