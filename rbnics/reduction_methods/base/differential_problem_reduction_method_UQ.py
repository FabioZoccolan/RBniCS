...
class DifferentialProblemReductionMethod(ReductionMethod):
    ...
    def initialize_training_set(self, ntrain, enable_import=True, sampling=None, typeGrid = 0, order_flag=False, **kwargs):
        print("In initialize_training_set 1 of differential_problem_reduction_method")
        return ReductionMethod.initialize_training_set(self, self.truth_problem.mu_range, ntrain, enable_import, sampling, typeGrid, order_flag, **kwargs)
        
    def initialize_testing_set(self, ntest, enable_import=False, sampling=None, **kwargs):
        print("In initialize_training_set 2 of differential_problem_reduction_method")
