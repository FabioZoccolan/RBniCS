...
class DifferentialProblemReductionMethod(ReductionMethod):
    ...
    def initialize_training_set(self, ntrain, enable_import=True, sampling=None, quadrature=0, typeGrid=0, **kwargs):
        print("In initialize_training_set of differential_problem_reduction_method")
        print("Exit initialize_training_set of differential_problem_reduction_method--going to reduction method")
        return ReductionMethod.initialize_training_set(
            self, self.truth_problem.mu_range, ntrain, enable_import, sampling, quadrature, typeGrid, **kwargs)
        

    def initialize_testing_set(self, ntest, enable_import=False, sampling=None, **kwargs):
        print("In initialize_testing_set of differential_problem_reduction_method")
