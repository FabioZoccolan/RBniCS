...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "UQ_OCSquare3_h_0.025_STAB_mu_2.4_1.2_alpha_0.01_d_2.1_beta7575_0202_w_montecarlo_2"
...
problem.solve()
problem.export_solution(filename="FEM_UQ_OC_Square3_h_0.025_STAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")
...
#reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")
#reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OC_Square3_h_0.025_OffONSTAB_mu_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")
...
#pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")
...
#print("")
#pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")

print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta7575_0202_w_montecarlo")
