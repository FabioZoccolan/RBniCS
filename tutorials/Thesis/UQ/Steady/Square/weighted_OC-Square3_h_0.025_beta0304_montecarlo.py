...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "UQ_OCSquare1_h_0.047_STAB_mu_2.4_1.2_alpha_0.01_d_2.1_beta0304_montecarlo"
...
mesh = Mesh("data/squareOC_h_0.047.xml")
subdomains = MeshFunction("size_t", mesh, "data/squareOC_h_0.047_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/squareOC_h_0.047_facet_region.xml")
...
beta_a = [[3 for _ in range(1)], [4 for _ in range(2)]]
beta_b = [[4 for _ in range(1)], [2 for _ in range(2)]]
...
problem.solve()
problem.export_solution(filename="FEM_UQ_OC_Square1_h_0.047_STAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OC_Square3_h_0.025_OffONSTAB_mu_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta0304_montecarlo")
