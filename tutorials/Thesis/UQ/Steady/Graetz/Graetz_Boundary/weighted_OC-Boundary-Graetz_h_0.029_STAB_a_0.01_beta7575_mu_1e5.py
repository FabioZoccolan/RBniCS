...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Beta7575/UQ_Boundary_Beta7575_OCGraetzPOD_h_0.029_STAB_alpha_1_7ex_yd_1.0_mu_1e5"
...
elliptic_optimal_control.export_solution(filename="UQ-BoundaryFEM_OCGraetz_STAB_h_0.029_alpha_1_mu_1e5_7ex_yd_1.0")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0")
