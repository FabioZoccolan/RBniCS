...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "UQ_scratch_OCGraetzPOD1_h_0.029_STAB_mu_1e5_alpha_0.01_beta7575"
...
pod_galerkin_method.initialize_testing_set(100, sampling=BetaDistribution(beta_a, beta_b), typeGrid=2, enable_import=True)
