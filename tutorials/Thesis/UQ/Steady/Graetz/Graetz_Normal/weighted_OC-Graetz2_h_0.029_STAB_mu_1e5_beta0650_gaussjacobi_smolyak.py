...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "UQ_OCGraetzPOD2_h_0.029_STAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak"
...
beta_a = [6 for _ in range(1)]
beta_b = [50 for _ in range(1)]
...
problem.solve()
problem.export_solution(filename="FEM_UQ_OCGraetz1_h_0.029_STAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0650_gaussjacobi_smolyak")
