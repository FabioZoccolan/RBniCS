...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "UQ_OCGraetzPOD1_h_0.029_STAB_mu_1e5_alpha_0.01_beta0402_MONTECARLO"
...
pod_galerkin_method.initialize_training_set(100, sampling=BetaDistribution(beta_a, beta_b), typegrid = 0)
...
problem.solve()
problem.export_solution(filename="FEM_UQ_OCGraetz1_h_0.029_STAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_beta0402_montecarlo")
