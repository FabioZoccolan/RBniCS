...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Article2/Beta0503_0503/OCGraetzPOD3_GEOM_STAB_h_0.034_mu_1e5_1.5_alpha_0.01_beta0301_0503_det_oldtest_Ntrain_100"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz3_GEOM_STAB_h_0.034_mu_1e5_1.5_alpha_0.01_beta0301_0503_det_oldtest_Ntrain_100")
