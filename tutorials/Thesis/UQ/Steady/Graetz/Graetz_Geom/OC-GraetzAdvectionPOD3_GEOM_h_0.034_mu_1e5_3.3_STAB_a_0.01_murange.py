...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Uniform/AdvectionOCGraetzPOD3_GEOM_STAB_h_0.034_mu_1e5_3.3_alpha_0.01_mu_rangediff"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz3_GEOM_STAB_h_0.034_mu_1e5_3.3_alpha_0.01_mu_rangediff")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")
reduced_elliptic_optimal_control.export_error(filename="online_error_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")
reduced_elliptic_optimal_control.export_error(filename="online_error_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_mu_rangediff")
