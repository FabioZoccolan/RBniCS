...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def __init__(self, block_V, **kwargs):
        ...
        self.y_0 = Expression("1.0", degree=1, domain=mesh) 
    ...
    def name(self):
        return "Numerical_Results/Beta_0503_0304/UQ_Parabolic_OCGraetzPOD2_GEOM_h_0.038_STAB_mu_1e5_3.3_beta0503_0304_montecarlo"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_UQ_OCGraetz2_GEOM_h_0.038_STAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_OCGraetz2_GEOM_h_0.038_OffSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_OCGraetz2_GEOM_h_0.038_OffONSTAB_mu_1e5_3.3_alpha_0.01_beta0503_0304_montecarlo")
