...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/UQ_Par_OCSquarePOD3_h_0.028_STAB_mu_2e4_1.2_alpha_0.01_beta0304_0402_montecarlo_d_1.0"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            for i in range(Nt):
                ...
                ms_2[i, i] =  -h * inner(p[i].dx(1),z[i])*dx
            for i in range(Nt-1):
                ms_0[i+1, i] = - inner(p[i+1],z[i])*dx 
                ms_1[i+1, i] = + h * inner(p[i+1].dx(0), z[i])*dx
                ms_2[i+1, i] = + h * inner(p[i+1].dx(1), z[i])*dx
            as0 = [[0, 0, 0], [0, 0, 0], [as0_0, 0, 0]]
            as1 = [[0, 0, 0], [0, 0, 0], [as1_0, 0, 0]]
            as2 = [[0, 0, 0], [0, 0, 0], [as2_0, 0, 0]]
            as3 = [[0, 0, 0], [0, 0, 0], [as3_0, 0, 0]]
            as4 = [[0, 0, 0], [0, 0, 0], [as4_0, 0, 0]]
            as5 = [[0, 0, 0], [0, 0, 0], [as5_0, 0, 0]]
            as6 = [[0, 0, 0], [0, 0, 0], [ms_0, 0, 0]]
            as7 = [[0, 0, 0], [0, 0, 0], [ms_1, 0, 0]]
            as8 = [[0, 0, 0], [0, 0, 0], [ms_2, 0, 0]]
...
# 1. Mesh
mesh = Mesh("data/squareOC1_h_0.028.xml")
subdomains = MeshFunction("size_t", mesh, "data/squareOC1_h_0.028_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/squareOC1_h_0.028_facet_region.xml")
...
elliptic_optimal_control.export_solution(filename="FEM_Par_UQ_OCSquare3_h_0.028_STAB_mu_2e4_1.2_alpha_0.01_beta0304_0402_montecarlo_d_1.0")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_UQ_OC_Square3_h_0.028_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo_beta0304")
reduced_elliptic_optimal_control.export_error(filename="online_error_OC_Square3_h_0.028_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo_beta0304")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_UQ_OC_Square3_h_0.028_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo_beta0304")
reduced_elliptic_optimal_control.export_error(filename="online_error_Par_UQ_OC_Square3_h_0.028_OffONSTAB_mu_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo_beta0304")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Par_UQ_OC_Square3_h_0.028_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Par_UQ_OC_Square3_h_0.028_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Par_UQ_OC_Square3_h_0.028_OffSTAB_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Par_UQ_OC_Square3_h_0.028_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta0304_0402_montecarlo")
