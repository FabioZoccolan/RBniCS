...
mesh = Mesh("data/graetz2.xml")
print("hmax", mesh.hmax())
subdomains = MeshFunction("size_t", mesh, "data/graetz2_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetz2_facet_region.xml")
