...
class AdvectionDominated(EllipticCoerciveProblem):
    ...
    def name(self):
        return "AdvectionRBGraetz-GEOM_NOSTAB_mu_1e4.8_3.3_d_1.1"
    ...
    def compute_theta(self, term):
        ...
        if term == "a":
            ...
            if self.stabilized:
                ...
                theta_a6 = 0.0 #delta * 4.0/(sqrt(mu[1]))
            else:
                theta_a5 = 0.0
                theta_a6 = 0.0
...
reduced_advection_dominated_problem.export_solution(filename="online_solution_GEOM_NOSTAB_mu_1e4.8_3.3_d_1.1_with_stabilization")
reduced_advection_dominated_problem.solve(online_stabilization=False)
reduced_advection_dominated_problem.export_solution(filename="online_solution_GEOM_NOSTAB_mu_1e4.8_3.3_d_1.1_without_stabilization")

# 7. Perform an error analysis
reduced_basis_method.initialize_testing_set(100)
reduced_basis_method.error_analysis(online_stabilization=True, filename="error_analysis_GEOM_STAB_mu_1e4.8_3.3_d_1.1_with_stabilization")
reduced_basis_method.error_analysis(online_stabilization=False, filename="error_analysis_GEOM_STAB_mu_1e4.8_3.3_d_1.1_without_stabilization")

# 8. Perform a speedup analysis
reduced_basis_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_GEOM_NOSTAB_mu_1e4.8_3.3_d_1.1_with_stabilization")
reduced_basis_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_GEOM_NOSTAB_mu_1e4.8_3.3_d_1.1_without_stabilization")
