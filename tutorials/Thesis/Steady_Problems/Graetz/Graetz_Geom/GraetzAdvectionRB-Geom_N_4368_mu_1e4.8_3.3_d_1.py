...
reduced_advection_dominated_problem.export_solution(filename="online_solution_GEOM_STAB_mu_1e4.8_3.3_d_1.1_with_stabilization")
reduced_advection_dominated_problem.solve(online_stabilization=False)
reduced_advection_dominated_problem.export_solution(filename="online_solution_GEOM_STAB_mu_1e4.8_3.3_d_1.1_without_stabilization")
...
reduced_basis_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_GEOM_STAB_mu_1e4.8_3.3_d_1.1_with_stabilization")
reduced_basis_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_GEOM_STAB_mu_1e4.8_3.3_d_1.1_without_stabilization")
