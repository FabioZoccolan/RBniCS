...
class AdvectionDominated(EllipticCoerciveProblem):
    ...
    def name(self):
        return "AdvectionPODGraetz-1_N_1143_STAB_mu_1e5_d_1"
...
mesh = Mesh("data/graetz_N_1143.xml")
print("hmax", mesh.hmax())
subdomains = MeshFunction("size_t", mesh, "data/graetz_N_1143_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetz_N_1143_facet_region.xml")
...
problem.solve()
problem.export_solution(filename="FEM_Graetz_STAB_N_1143_offline_mu_1e5_d_1")


# 4. Prepare reduction with a reduced basis method
reduction_method = PODGalerkin(problem)
reduction_method.set_Nmax(50)
reduction_method.set_tolerance(1e-7) # 5*1e-7
...
reduced_problem.export_solution(filename="online_solution_Graetz_STAB_N_1143_with_stabilization_mu_1e5_d_1")
reduced_problem.solve(online_stabilization=False)
reduced_problem.export_solution(filename="online_solution_Graetz_STAB_N_1143_without_stabilization_mu_1e5_d_1")

# 7. Perform an error analysis
reduction_method.initialize_testing_set(100)
reduction_method.error_analysis(online_stabilization=True, filename="error_analysis_Graetz_STAB_N_1143_with_stabilization_mu_1e5_d_1")
reduction_method.error_analysis(online_stabilization=False, filename="error_analysis_Graetz_STAB_N_1143_without_stabilization_mu_1e5_d_1")

# 8. Perform a speedup analysis
reduction_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Graetz_STAB_N_1143_with_stabilization_mu_1e5_d_1")
reduction_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Graetz_STAB_N_1143_without_stabilization_mu_1e5_d_1") 
