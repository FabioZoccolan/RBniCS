...
class AdvectionDominated(EllipticCoerciveProblem):
    ...
    def name(self):
        return "AdvectionPODGraetz-1_N_5503_STAB_mu_1e5_d_1"
...
problem.solve()
problem.export_solution(filename="FEM_Graetz_STAB_N_5503_offline_mu_1e5_d_1")
...
reduced_problem.export_solution(filename="online_solution_Graetz_STAB_N_5503_with_stabilization_mu_1e5_d_1")
reduced_problem.solve(online_stabilization=False)
reduced_problem.export_solution(filename="online_solution_Graetz_STAB_N_5503_without_stabilization_mu_1e5_d_1")

# 7. Perform an error analysis
reduction_method.initialize_testing_set(100)
reduction_method.error_analysis(online_stabilization=True, filename="error_analysis_Graetz_STAB_N_5503_with_stabilization_mu_1e5_d_1")
reduction_method.error_analysis(online_stabilization=False, filename="error_analysis_Graetz_STAB_N_5503_without_stabilization_mu_1e5_d_1")

# 8. Perform a speedup analysis
reduction_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Graetz_STAB_N_5503_with_stabilization_mu_1e5_d_1")
reduction_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Graetz_STAB_N_5503_without_stabilization_mu_1e5_d_1") 
