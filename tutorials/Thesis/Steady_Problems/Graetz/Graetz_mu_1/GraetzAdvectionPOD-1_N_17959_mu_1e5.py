...
class AdvectionDominated(EllipticCoerciveProblem):
    ...
    def name(self):
        return "AdvectionPODGraetz-1Ex_N_17959_STAB_mu_1e5_d_1"
...
mesh = Mesh("data/graetz_N_17959.xml")
print("hmax", mesh.hmax())
subdomains = MeshFunction("size_t", mesh, "data/graetz_N_17959_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetz_N_17959_facet_region.xml")
...
problem.solve()
problem.export_solution(filename="FEM_Graetz_N_17959_mu_1e5_d_1_with_stabilization")
...
reduced_problem.export_solution(filename="online_solution_Graetz_N_17959_mu_1e5_d_1_with_stabilization")
reduced_problem.solve(online_stabilization=False)
reduced_problem.export_solution(filename="online_solution_Graetz_N_17959_mu_1e5_d_1_without_stabilization")

# 7. Perform an error analysis
reduction_method.initialize_testing_set(100)
reduction_method.error_analysis(online_stabilization=True, filename="error_analysis_Graetz_N_17959_mu_1e5_d_1_with_stabilization")
reduction_method.error_analysis(online_stabilization=False, filename="error_analysis_Graetz_N_17959_mu_1e5_d_1_without_stabilization")

# 8. Perform a speedup analysis
reduction_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Graetz_N_17959_mu_1e5_d_1_with_stabilization")
reduction_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Graetz_N_17959_mu_1e5_d_1_without_stabilization") 
