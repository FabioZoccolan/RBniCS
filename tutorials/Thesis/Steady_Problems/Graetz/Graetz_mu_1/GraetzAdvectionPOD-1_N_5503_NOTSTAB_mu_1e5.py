...
class AdvectionDominated(EllipticCoerciveProblem):
    ...
    def name(self):
        return "AdvectionPODGraetz-1_N_5503_NOTSTAB_mu_1e5"
...
problem.solve()
problem.export_solution(filename="FEM_Graetz_NOSTAB_N_5503_offline_mu_1e5")
...
reduced_problem.export_solution(filename="online_solution_Graetz_NOSTAB_N_5503_without_stabilization_mu_1e5")

# 7. Perform an error analysis
reduction_method.initialize_testing_set(100)
reduction_method.error_analysis(online_stabilization=True, filename="error_analysis_Graetz_NOSTAB_N_5503_with_stabilization_mu_1e5")
reduction_method.error_analysis(online_stabilization=False, filename="error_analysis_Graetz_NOSTAB_N_5503_without_stabilization_mu_1e5")

# 8. Perform a speedup analysis
reduction_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Graetz_NOSTAB_N_5503_with_stabilization_mu_1e5")
reduction_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Graetz_NOSTAB_N_5503_without_stabilization_mu_1e5") 
