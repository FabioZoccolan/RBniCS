...
class AdvectionDominated(EllipticCoerciveProblem):
    ...
    def name(self):
        return "AdvectionSquareRB_N_1107_mu_2e4_1.2_d_2.1"
...
reduced_problem.export_solution(filename="online_solution_adsquare_STAB_N_1107_with_stabilization_mu_2e4_1.2_d_2.1") 

reduced_problem.solve(online_stabilization=False)
reduced_problem.export_solution(filename="online_solution_adsquare_STAB_N_1107_without_stabilization_mu_2e4_1.2_d_2.1")
# 7. Perform an error analysis
reduction_method.initialize_testing_set(100)
reduction_method.error_analysis(online_stabilization=True, filename="error_analysis_adsquare_STAB_N_1107_with_stabilization_mu_2e4_1.2_d_2.1")
reduction_method.error_analysis(online_stabilization=False, filename="error_analysis_adsquare_STAB_N_1107_without_stabilization_mu_2e4_1.2_d_2.1")

# 8. Perform a speedup analysis
reduction_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_adsquare_STAB_N_1107_with_stabilization_mu_2e4_1.2_d_2.1")
reduction_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_adsquare_STAB_N_1107_without_stabilization_mu_2e4_1.2_d_2.1")
