...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Parabolic_OCSquarePOD2_h_0.025_mu_2e4_1.2_alpha_0.01_d_2.1"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCSquare2_h_0.025_mu_2e4_1.2_alpha_0.01_d_2.1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCSquare2_h_0.025_mu_2e4_1.2_alpha_0.01_d_2.1")
