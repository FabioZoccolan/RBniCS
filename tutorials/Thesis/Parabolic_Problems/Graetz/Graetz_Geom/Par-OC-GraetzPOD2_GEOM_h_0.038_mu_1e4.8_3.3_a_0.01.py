...
### Setting: Parabolic + OC mu=1e5 NOSTAB
...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Parabolic_OCGraetzPOD2_GEOM_h_0.038_mu_1e4.8_3.3_alpha_0.01_d_1"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            a5 = [[0, 0, 0], [0, 0, 0], [m_0, 0, 0]]
            a6 = [[0, 0, 0], [0, 0, 0], [m_1, 0, 0]]
            
            return (BlockForm(a0), BlockForm(a1), BlockForm(a2),  BlockForm(a3), BlockForm(a4), BlockForm(a5), BlockForm(a6))
        elif term == "a*":
            z = self.z
            p = self.p
            ...
            as5 = [[0, 0, ms_0], [0, 0, 0], [0, 0, 0]]
            as6 = [[0, 0, ms_1], [0, 0, 0], [0, 0, 0]]
            
            return (BlockForm(as0), BlockForm(as1), BlockForm(as2),  BlockForm(as3), BlockForm(as4), BlockForm(as5), BlockForm(as6))
        elif term == "c":
            u = self.u
            q = self.q
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCGraetz2_GEOM_h_0.038_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz2_GEOM_h_0.038_mu_1e5_alpha_0.01")
