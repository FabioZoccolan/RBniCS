...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def __init__(self, block_V, **kwargs):
        ...
        self.y_0 = Expression("2.0", degree=1, domain=mesh)  #Expression("1.0", degree=1, domain=mesh) 
    ...
    def name(self):
        return "Parabolic_OCGraetzPOD2_GEOM_h_0.020_STAB_mu_1e4.8_3.3_alpha_0.01_d_1"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            bc0 = BlockDirichletBC([[[DirichletBC(block_V.sub(i), Constant(2.0), self.boundaries, 1),
                                      DirichletBC(block_V.sub(i), Constant(1.0), self.boundaries, 2),
                                      DirichletBC(block_V.sub(i), Constant(1.0), self.boundaries, 4),
                                      DirichletBC(block_V.sub(i), Constant(2.0), self.boundaries, 5),
                                      DirichletBC(block_V.sub(i), Constant(2.0), self.boundaries, 6)] for i in range(0, Nt)], None, None])
            return (bc0,)
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCGraetz2_GEOM_h_0.020_STAB_mu_1e5_alpha_0.01")
