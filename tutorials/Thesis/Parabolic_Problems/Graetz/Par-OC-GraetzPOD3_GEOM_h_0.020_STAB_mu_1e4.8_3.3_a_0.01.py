...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Parabolic_OCGraetzPOD3_GEOM_h_0.020_STAB_mu_1e4.8_3.3_alpha_0.01_d_1"
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCGraetz3_GEOM_h_0.020_STAB_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz3_GEOM_STAB_h_0.020_mu_1e5_alpha_0.01")
