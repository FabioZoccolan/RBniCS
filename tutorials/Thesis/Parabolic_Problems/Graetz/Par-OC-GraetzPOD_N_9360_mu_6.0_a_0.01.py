...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Parabolic_OCGraetzRB_N_9360_mu_6.0_alpha_0.01"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            #f0_0[0] = inner(y_0, q[0])*dxfor i in range(2*Nt, 3*Nt)
            y_0 = self.y_0
            f0_0 = zeros(Nt, dtype=object)
            f0_0[0] = inner(y_0, q[0])*dx #inner(Constant(0.0), q[0])*dx 
...
# 1. Mesh
mesh = Mesh("data/graetzOC_N_9360.xml")
subdomains = MeshFunction("size_t", mesh, "data/graetzOC_N_9360_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetzOC_N_9360_facet_region.xml")
...
elliptic_optimal_control.export_solution(filename="FEM_Par_OCGraetz_N_9360_mu_6.0_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Par_OCGraetz_N_9360_mu_6.0_alpha_0.01")

# In[ ]:


#plot(reduced_solution, reduced_problem=reduced_elliptic_optimal_control, component="y")


# In[ ]:


#plot(reduced_solution, reduced_problem=reduced_elliptic_optimal_control, component="u")


# In[ ]:


#plot(reduced_solution, reduced_problem=reduced_elliptic_optimal_control, component="p")
