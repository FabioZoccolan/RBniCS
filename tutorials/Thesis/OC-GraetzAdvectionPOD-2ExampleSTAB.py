...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCSTABGraetzPOD2Ex"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            a5 = h * vel * y.dx(0) * q.dx(0) * dx(1)  #in case, change the domain of integration
            a6 = h * vel * y.dx(0) * q.dx(0) * dx(2) 
            ...
            as5 = -h * vel * p.dx(0) * z.dx(0) * dx(1)
            as6 = -h * vel * p.dx(0) * z.dx(0) * dx(2) #
