...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCSquarePOD-1_N_3594_mu_2.4_1.2_d_2.1_alpha_1_STST"
...
problem.solve()
problem.export_solution(filename="FEM_OC_Square_N_3594_mu_2.4_1.2_d_2.1_alpha_1_STST")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OC_Square_N_3594_mu_2.4_1.2_d_2.1_alpha_1_STST")
