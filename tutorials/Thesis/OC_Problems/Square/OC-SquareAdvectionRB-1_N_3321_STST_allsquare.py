...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCSquareRB_N_3321_mu_2.4_1.2_d_2.1_alpha_0.01_STST_allsquare"
...
reduced_problem.export_solution(filename="online_solution_OC_Square_N_3321_mu_2.4_1.2_d_2.1_alpha_0.01_STST_allsquare")
