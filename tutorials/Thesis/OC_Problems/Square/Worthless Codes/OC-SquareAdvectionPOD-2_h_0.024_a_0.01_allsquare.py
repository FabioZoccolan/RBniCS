...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCSquarePOD2_h_0.024_mu_2.4_1.2_alpha_0.01_allsquare"
...
problem.solve()
problem.export_solution(filename="FEM_OC_Square2_h_0.024_mu_2.4_1.2_alpha_0.01_allsquare")
...
reduced_elliptic_optimal_control.export_solution(filename="FEM_OC_Square2_h_0.024_mu_2.4_1.2_alpha_0.01_allsquare")
