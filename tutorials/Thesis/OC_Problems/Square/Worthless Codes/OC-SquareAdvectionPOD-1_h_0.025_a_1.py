...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCSquarePOD1_h_0.025_mu_2.4_1.2_alpha_1"
...
problem.solve()
problem.export_solution(filename="FEM_OC_Square1_h_0.025_mu_2.4_1.2_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OC_Square1_h_0.025_mu_2.4_1.2_alpha_1")
