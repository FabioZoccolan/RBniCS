...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCSquarePOD_N_3321_mu_2.4_1.2_alpha_1_allsquare"
...
reduced_elliptic_optimal_control.export_solution(filename="FEM_OC_Square_N_3321_mu_2.4_1.2_alpha_1_allsquare")
