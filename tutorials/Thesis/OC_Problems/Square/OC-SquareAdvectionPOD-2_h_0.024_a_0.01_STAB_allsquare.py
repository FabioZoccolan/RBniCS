...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCSquarePOD2_h_0.024_STAB_mu_2.4_1.2_alpha_0.01_allsquare"
...
mesh = Mesh("data/square_h_0.024.xml")
subdomains = MeshFunction("size_t", mesh, "data/square_h_0.024_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/square_h_0.024_facet_region.xml")
...
problem.solve()
problem.export_solution(filename="FEM_OC_Square2_h_0.024_STAB_mu_2.4_1.2_alpha_0.01_allsquare")
...
reduced_elliptic_optimal_control.export_solution(filename="FEM_OC_Square2_h_0.024_STAB_mu_2.4_1.2_alpha_0.01_allsquare")
