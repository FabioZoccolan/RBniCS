...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_resultsss/AdvectionOCSquarePOD3__STAB_mu_2.4_1.2_alpha_0.01"
...
mesh = Mesh("data/squareOC_.xml")
subdomains = MeshFunction("size_t", mesh, "data/squareOC__physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/squareOC__facet_region.xml")
...
problem.solve()
problem.export_solution(filename="FEM_OC_Square3__STAB_mu_2.4_1.2_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OC_Square3__OffSTAB_mu_2.4_1.2_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_OC_Square3__OffSTAB_mu_2.4_1.2_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OC_Square3__OffONSTAB_mu_2.4_1.2_alpha_0.01")
reduced_elliptic_optimal_control.export_error(filename="online_error_OC_Square3__OffONSTAB_mu_2.4_1.2_alpha_0.01")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_OC_Square3__OffSTAB_mu_2.4_1.2_alpha_0.01")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_OC_Square3__OffONSTAB_mu_2.4_1.2_alpha_0.01")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_OC_Square3__OffSTAB_mu_2.4_1.2_alpha_0.01")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_OC_Square3__OffONSTAB_mu_2.4_1.2_alpha_0.01")
