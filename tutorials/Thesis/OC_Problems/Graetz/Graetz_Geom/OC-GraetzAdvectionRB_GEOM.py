...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzRB_GEOM_mu_1e4.8_3.3_alpha_0.01"
...
mesh = Mesh("data/graetzOC_N_4368.xml")
subdomains = MeshFunction("size_t", mesh, "data/graetzOC_N_4368_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetzOC_N_4368_facet_region.xml")
...
reduced_problem.export_solution(filename="online_solution_OCGraetzGEOM_mu_1e4.8_3.3_alpha_0.01")
