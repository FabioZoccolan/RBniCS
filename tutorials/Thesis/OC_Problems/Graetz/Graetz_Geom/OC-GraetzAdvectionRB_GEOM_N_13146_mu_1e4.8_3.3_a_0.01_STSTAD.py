...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzRB_GEOM_STSTAD_N_13146_mu_1e4.8_3.3_alpha_0.01"
...
reduced_problem.export_solution(filename="online_solution_OCGraetz_GEOM_STSTAD_N_13146_mu_1e4.8_3.3_alpha_0.01")
