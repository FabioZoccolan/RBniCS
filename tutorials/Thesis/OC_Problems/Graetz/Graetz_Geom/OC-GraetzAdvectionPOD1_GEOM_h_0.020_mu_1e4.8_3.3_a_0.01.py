...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD1_GEOM_h_0.020_mu_1e4.8_3.3_alpha_0.01"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            a2 = y.dx(0) * q.dx(1) * dx(2)
            a3 = y.dx(0) * q.dx(0) * dx(2)
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz1_GEOM_h_0.020_mu_1e4.8_3.3_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz1GEOM_h_0.020_mu_1e4.8_3.3_alpha_0.01")
