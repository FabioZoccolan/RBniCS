...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/AdvectionOCGraetzPOD3_GEOM_STAB_h_0.034_mu_1e5_3.3_alpha_0.01_final"
...
mu_range = [(1e4, 1e6), (1, 3.0)]
problem.set_mu_range(mu_range)


offline_mu = (1e5,3.0) #(10**4.8, 3.3)
problem.init()
problem.set_mu(offline_mu)
problem.solve()
problem.export_solution(filename="FEM_OCGraetz3_GEOM_STAB_h_0.034_mu_1e5_3.3_alpha_0.01_final")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_final")
reduced_elliptic_optimal_control.export_error(filename="online_error_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_final")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_final")
reduced_elliptic_optimal_control.export_error(filename="online_error_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_final")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_final")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_final")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_OCGraetz3_GEOM_h_0.034_OffSTAB_mu_1e5_3.3_alpha_0.01_final")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_OCGraetz3_GEOM_h_0.034_OffONSTAB_mu_1e5_3.3_alpha_0.01_final")
