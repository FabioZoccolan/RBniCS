...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD2_GEOM_h_0.020_mu_1e4.8_3.3_alpha_0.01"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz2_GEOM_h_0.020_mu_1e4.8_3.3_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz2_GEOM_h_0.020_mu_1e4.8_3.3_alpha_0.01")
