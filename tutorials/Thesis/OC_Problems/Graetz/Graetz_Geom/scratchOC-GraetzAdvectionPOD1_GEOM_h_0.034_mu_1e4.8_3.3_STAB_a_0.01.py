...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "scratchAdvectionOCGraetzPOD1_GEOM_STAB_N_13146_mu_1e4.8_3.3_alpha_0.01"
...
mesh = Mesh("data/graetzOC_N_13146.xml")
subdomains = MeshFunction("size_t", mesh, "data/graetzOC_N_13146_physical_region.xml")
boundaries = MeshFunction("size_t", mesh, "data/graetzOC_N_13146_facet_region.xml")
...
offline_mu = (10**4.8, 2.5)
problem.init()
problem.set_mu(offline_mu)
problem.solve()
problem.export_solution(filename="FEM_OCGraetz1_GEOM_STAB_N_13146_mu_1e4.8_3.3_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz1_GEOM_STAB_N_13146_mu_1e4.8_3.3_alpha_0.01")
