...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD1_GEOM_STAB_h_0.020_mu_1e4.8_1.8_alpha_0.01"
...
offline_mu = (10**4.8, 1.8)
problem.init()
problem.set_mu(offline_mu)
problem.solve()
problem.export_solution(filename="FEM_OCGraetz1_GEOM_STAB_h_0.020_mu_1e4.8_1.8_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz1_GEOM_STAB_h_0.020_mu_1e4.8_1.8_alpha_0.01")
