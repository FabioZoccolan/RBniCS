...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzRB_GEOM_N_13146_mu_1e4.8_3.3_alpha_0.1"
...
reduced_problem.export_solution(filename="online_solution_OCGraetzGEOM_N_13146_mu_1e4.8_3.3_alpha_0.1")
