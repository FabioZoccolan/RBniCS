...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Numerical_Results/Boundary_OCGraetzPOD_h_0.029_NOTSTAB_7ex"
...
elliptic_optimal_control.export_solution(filename="BoundaryFEM_OCGraetz_notSTAB_h_0.029_mu_1e5_alpha_0.01_mu_100000_7ex")
...
print("NOT STAB: Reduced output for mu =", online_mu, "is", reduced_elliptic_optimal_control.compute_output())
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Boundary_OCGraetz2_h_0.029_notSTAB_alpha_0.01_mu_100000_7ex")
reduced_elliptic_optimal_control.export_error(filename="online_error_Boundary_OCGraetz2_h_0.029_notSTAB_alpha_0.01_mu_100000_7ex")
...
print("\n----------------------------------------ONLINE SOLUTION ERROR ANALYSIS BEGINS-------------------------------------------------\n")

pod_galerkin_method.error_analysis(filename="error_analysis_Boundary_OCGraetz2_h_0.029_notSTAB_alpha_0.01_mu_100000_7ex")
...
print("\n-----------------------------------------ONLINE SOLUTION SPEED-UP ANALYSIS BEGINS----------------------------------------------\n")
print("")
pod_galerkin_method.speedup_analysis(filename="speedup_analysis_Boundary_OCGraetz2_h_0.029_notSTAB_alpha_0.01_mu_100000_7ex")
