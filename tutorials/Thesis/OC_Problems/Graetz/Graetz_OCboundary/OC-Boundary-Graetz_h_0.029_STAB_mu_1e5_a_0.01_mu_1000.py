...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Boundary_OCGraetzPOD_h_0.029_mu_1e5_alpha_0.01_mu_1000"
...
elliptic_optimal_control.export_solution(filename="BoundaryFEM_OCGraetz_h_0.029_mu_1e5_alpha_0.01_mu_1000")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Boundary_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_mu_1000")
reduced_elliptic_optimal_control.export_error(filename="online_error_Boundary_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_mu_1000")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_Boundary_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_mu_1000")
reduced_elliptic_optimal_control.export_error(filename="online_error_Boundary_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_mu_1000")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_Boundary_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_mu_1000")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_Boundary_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_mu_1000")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_Boundary_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_mu_1000")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_Boundary_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_mu_1000")
