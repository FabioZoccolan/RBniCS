...
###  Setting Problem: mu = 6.0 alpha=1
...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD1_h_0.040_mu_6.0_alpha_1"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz1_h_0.040_mu_6.0_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz1_h_0.040_mu_6.0_alpha_1")
