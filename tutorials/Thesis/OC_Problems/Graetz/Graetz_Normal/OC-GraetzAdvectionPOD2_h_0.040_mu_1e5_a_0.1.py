...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD2_h_0.040_mu_1e5_alpha_0.1"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz2_h_0.040_mu_1e5_alpha_0.1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz2_h_0.040_mu_1e5_alpha_0.1")
