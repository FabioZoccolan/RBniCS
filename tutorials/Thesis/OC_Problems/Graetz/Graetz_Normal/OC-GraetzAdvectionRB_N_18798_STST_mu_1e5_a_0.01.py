...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzRB_N_18798_STST_mu_1e5_alpha_0.01"
...
reduced_problem.export_solution(filename="online_solution_OCGraetz_N_18798_STST_mu_1e5_alpha_0.01")
