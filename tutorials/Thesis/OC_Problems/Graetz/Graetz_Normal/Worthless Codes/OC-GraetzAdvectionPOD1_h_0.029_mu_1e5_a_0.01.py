...
####  Setting Problem: mu = 1e5 alpha=0.01 NO STAB 
...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD1_h_0.029_mu_1e5_alpha_0.01"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz1_h_0.029_mu_1e5_alpha_0.01")

# ### Prepare reduction with a reduced basis method with POD
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz1_h_0.029_mu_1e5_alpha_0.01")
