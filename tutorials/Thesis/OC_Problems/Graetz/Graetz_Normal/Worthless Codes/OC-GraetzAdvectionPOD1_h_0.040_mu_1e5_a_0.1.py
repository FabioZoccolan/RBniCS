...
###  Setting Problem: mu = 1e5 alpha=0.1
...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD1_h_0.040_mu_1e5_alpha_0.1"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz1_h_0.040_mu_1e5_alpha_0.1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz1_h_0.040_mu_1e5_alpha_0.1")
