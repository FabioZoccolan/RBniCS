...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD_N_9360_STSTAD_mu_6.0_alpha_0.01_d_1"
...
mu_range = [(1, 1e6), (0.5, 4.0)] #(0.01, 1e6), (0.5,4.0)
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz_N_9360_STSTAD_mu_6.0_alpha_0.01_d_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz_N_9360STSTAD_mu_6.0_alpha_0.01_d_1")
