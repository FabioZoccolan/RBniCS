...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD_BC2_N_9360_STST_mu_6.0_alpha_0.01_d_1"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            as1 = -vel * p.dx(0) * z * dx
            as2 = Constant(0.0) * - h * vel * p.dx(0) * z.dx(0) * dx(1)
            as3 = Constant(0.0) * - h * vel * p.dx(0) * z.dx(0) * dx(2)
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz_BC2_N_9360_STST_mu_6.0_alpha_0.01_d_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz_N_9360_BC2_STST_mu_6.0_alpha_0.01_d_1")
