...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzRB_N_9360_STSTAD_mu_6.0_alpha_0.1_d_1"
...
reduced_problem.export_solution(filename="online_solution_OCGraetz_N_9360_STSTAD_mu_6.0_alpha_0.1_d_1")
