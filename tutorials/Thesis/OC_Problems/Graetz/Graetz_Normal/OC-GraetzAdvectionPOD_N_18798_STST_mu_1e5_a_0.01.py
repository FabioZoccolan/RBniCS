...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD_N_18798_STST_mu_1e5_alpha_0.01"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            as3 = Constant(0.0) * - h * vel * p.dx(0) * z.dx(0) * dx(2) +  Constant(0.0) *  - h * vel * p.dx(0) * z.dx(0) * dx(3) + Constant(0.0) * - h * vel * p.dx(0) * z.dx(0) * dx(4)
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz_N_18798_STST_mu_1e5_alpha_0.01")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz_N_18798_STST_mu_1e5_alpha_0.01")
