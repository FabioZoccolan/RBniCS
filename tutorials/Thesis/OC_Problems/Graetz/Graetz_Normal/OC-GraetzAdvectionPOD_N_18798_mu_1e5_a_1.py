...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD_N_18798_mu_1e5_alpha_1"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz_N_18798_mu_1e5_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz_N_18798_mu_1e5_alpha_1")
