...
###  Setting Problem: mu = 1e5 alpha=0.1 STAB delta=1
...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD1_h_0.040_STAB_mu_1e5_alpha_0.1_d_1"
    ...
    def assemble_operator(self, term):
        ...
        if term == "a":
            ...
            m1 = - h * y * z.dx(0) * dx#(3) - h * y * z.dx(0) * dx(4)#aggiunto io
            return (m0,m1)
        elif term == "n":
            u = self.u
            v = self.v
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz1_h_0.040_STAB_mu_1e5_alpha_0.1_d_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz1_h_0.040_STAB_mu_1e5_alpha_0.1_d_1")
