...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD_N_9360_mu_6.0_alpha_1"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz_N_9360_mu_6.0_alpha_1")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz_N_9360_mu_6.0_alpha_1")
