...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "AdvectionOCGraetzPOD2_h_0.029_STAB_mu_1e5_alpha_0.01_testing"
...
problem.solve()
problem.export_solution(filename="FEM_OCGraetz2_h_0.029_STAB_mu_1e5_alpha_0.01_testing")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_testing")
reduced_elliptic_optimal_control.export_error(filename="online_error_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_testing")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_testing")
reduced_elliptic_optimal_control.export_error(filename="online_error_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_testing")

reduced_solution_N_7 = reduced_elliptic_optimal_control.solve(online_stabilization=True, N = 7) 
reduced_elliptic_optimal_control.export_solution(filename="online_solution_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_testing_N_7")
reduced_elliptic_optimal_control.export_error(filename="online_error_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_testing_N_7")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_testing")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_testing")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_OCGraetz2_h_0.029_OffSTAB_mu_1e5_alpha_0.01_testing")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_OCGraetz2_h_0.029_OffONSTAB_mu_1e5_alpha_0.01_testing")
