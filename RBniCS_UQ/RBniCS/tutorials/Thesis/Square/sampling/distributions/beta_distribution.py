...
class BetaDistribution(CompositeDistribution):
    def __init__(self, a, b):
        ...
        CompositeDistribution.__init__(self, [DrawFrom(random.beta, a=a_p, b=b_p) for (a_p, b_p) in zip(a, b)], 'GaussJacobi', is_loguniform=False) #'GaussJacobi',  'HaltonBeta', 'UniformClenshawCurtisBeta'
