...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "Article2/Beta1010_1010/UQ_OCSquare3_h_0.025_STAB_mu_2.4_1.2_alpha_0.01_d_2.1_beta1010_1010_gauss_smolyak"
...
problem.solve()
problem.export_solution(filename="FEM_UQ_OC_Square3_h_0.025_STAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_OC_Square3_h_0.025_OffONSTAB_mu_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_OC_Square3_h_0.025_OffSTAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")

print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_OC_Square3_h_0.025_OffONSTAB_mu_2.4_1.2_alpha_0.01_beta1010_1010_gauss_smolyak")
