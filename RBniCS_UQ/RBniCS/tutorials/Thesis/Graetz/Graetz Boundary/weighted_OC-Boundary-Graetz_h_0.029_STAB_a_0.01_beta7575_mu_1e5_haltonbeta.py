...
class EllipticOptimalControl(EllipticOptimalControlProblem):
    ...
    def name(self):
        return "beta7575/Boundary_beta7575_OCGraetzPOD_h_0.029_STAB_alpha_1_7ex_yd_1.0_mu_1e5_haltonbeta"
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")
...
reduced_elliptic_optimal_control.export_solution(filename="online_solution_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")
reduced_elliptic_optimal_control.export_error(filename="online_error_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")
...
pod_galerkin_method.error_analysis(online_stabilization=False, filename="error_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")

print("\n--------------------------------------ONLINE-OFFLINE STABILIZATION ERROR ANALYSIS BEGINS--------------------------------------------\n")

pod_galerkin_method.error_analysis(online_stabilization=True, filename="error_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")
...
print("")
pod_galerkin_method.speedup_analysis(online_stabilization=False, filename="speedup_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")
print("\n---------------------------------------ONLINE-OFFLINE STABILIZATION SPEED-UP ANALYSIS BEGINS------------------------------------------\n")
pod_galerkin_method.speedup_analysis(online_stabilization=True, filename="speedup_analysis_UQ_Boundary_beta7575_OCGraetz2_h_0.029_OffONSTAB_alpha_1_mu_1e5_7ex_yd_1.0_haltonbeta")
