...
def OnlineRectificationDecoratedReducedProblem(EllipticOptimalControlReducedProblem_DerivedClass):

    @PreserveClassName
    class OnlineRectificationDecoratedReducedProblem_Class(EllipticOptimalControlReducedProblem_DerivedClass):
