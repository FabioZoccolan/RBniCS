...
def PODGalerkinReduction(DifferentialProblemReductionMethod_DerivedClass):
    ...
    class PODGalerkinReduction_Class(DifferentialProblemReductionMethod_DerivedClass):
        ...
        def __init__(self, truth_problem, **kwargs):
            print("PodGalRedClass::initialized")
        ...
        def _init_offline(self):
            print("PodGalRedClass._init_offline::called")
            ...
            if len(self.truth_problem.components) > 1:
                self.POD = dict()
                for component in self.truth_problem.components:
                    print("PodGalRedClass._init_offline::component=", component)
        ...
        def offline(self):
            ...
            """
            print("\n\nPodGalRedClass.offline::>>>>>>>>>>>>>>Started offline")
            need_to_do_offline_stage = self._init_offline()
            if need_to_do_offline_stage:
                self._offline()
            self._finalize_offline()
            return self.reduced_problem
            print("\n\nPodGalRedClass.offline::>>>>>>>>>>>>>>>>Did offline")
        ...
        def _offline(self):
            ...
            print(self.reduced_problem.build_reduced_operators())
        ...
        def compute_basis_functions(self):
            ...
            """
            print("PodGalRedClass::In compute_basis_functions. THIS METHOD IS NOT CALLED")
            if len(self.truth_problem.components) > 1:
                print("PodGlaRedClass::I am hereeeeeeeeeeeeee")
                for component in self.truth_problem.components:
                ...
                print("PodGalRedClass::Preparing partitioned POD")
        ...
        def _error_analysis(self, N_generator=None, filename=None, **kwargs):
            ...
            for (mu_index, mu) in enumerate(self.testing_set):
                ...
                for n in range(1, N + 1): # n = 1, ... N
                    ...
                    if n_arg is not None:
                        ...
                        print("In _error analysis, n_args is None")
                        if len(components) > 1:
            ...
            #print("error_analysis_table[error_ypsi, 1,1]", error_analysis_table["error_ypsi", 1,1])
            # Print
            print("")
