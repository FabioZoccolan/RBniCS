...
class ParametrizedProblem(object):
    ...
    def __init__(self, folder_prefix):
        print("ParametrizedProblem::initialized")
    ...
    def set_mu_range(self, mu_range):
        print("ParamatrizedProblem.set_mu_range::called")
        """
